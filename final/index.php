...
<a id="btnHome" href="index.php?action=home" 
	style="background-color: #ffff00;
	border:#536684  1px solid;
	padding: 5px 10px;
	color: #536684; 
	float: right;
...
<td><a href="index.php?action=checkout" class="btnCheckoutAction"><img width="100px" src="checkoutbtn.png" alt="Ckeck Out" /></a></td>
</tr>
</tbody>
</table>		
  <?php
