...
<BODY>
	...
	<div><a href="cart.php?action=login"><img class="div-3" title="Login !" src="Images/login.png" width="25px"/></a></a></div>
	...
	<img class="div-2" title="Back Home!" src="Images/home-1.png" width="25px"/></a>
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="cart.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="Images/delete.png" width="20px" title="Remove Item" /></a></td>
				</tr>
				</form>	
				<?php
...
<td><a href="cart.php?action=empty"><img src="Images/empty.png" width="35px" title="Empty cart !"/></a></td>
</tr>
</tbody>
</table>	
  <?php
...
<?php
 if(!empty($_SESSION["cart_item"])) {?>
<div style="margin-left:640px; position:absolute;"><a href="cart.php?action=checkout" ><img src="Images/checkout.png" width="200px" title="Check Out!" /></a></div><br><br><br>
<br><br>
<div class="font" id="subtotal" style="background-color: #efd1bd;
	...
	<div>
		<a href="cart.php?action=checkout" ><img title="Buy Now!" src="Images/paypal.png" width="200px"  style="margin-left:16.5%; margin-top:3%;"/></a>
	</div>
</div>
 <?php 
 } 
